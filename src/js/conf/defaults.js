module.exports = {
    ...
    pipelines: {
        build: {
            "js": [
                {idn: "bundle:js", src: "./src", dst: "./dist", sxt: ".js", dxt: ".js"},
            ],
            "css": [
        ...
        distribute: {
            "js": [
                ...
                {idn: "test:js", src: "./test/js", dst: null, sxt: ".js", dxt: null},
                {idn: "bundle:js", src: "./src", dst: "./dist", sxt: ".js", dxt: ".js"},
                {idn: "minify:js", src: "./dist", dst: "./dist", sxt: ".js", dxt: ".min.js"},
                {idn: "compress:js", src: "./dist", dst: "./dist", sxt: ".min.js", dxt: ".min.js.tar.gz"},

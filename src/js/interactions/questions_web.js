/**
 * @file warhorse
 * @description Convention creation questions: Web.
...
function questions() {
    ...
    answers.warhorse.toolingStyle = styleTools[styleToolIdx].toLowerCase();
    ...
    answers.warhorse.toolingTemplates = templateTools[templateToolIdx].toLowerCase();
    console.log(`templateTool: ${answers.warhorse.toolingTemplates}`);
